...
export default function AuditorDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      await Promise.all([loadPendingDestinations(), loadPendingVerifications()]);
    } catch (err: any) {
  ...
  const loadPendingDestinations = async () => {
    try {
      const response = await dashboardService.getPendingDestinations({
        limit: 10,
      });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold font-display text-uganda-black mb-6">
            Pending Destinations for Review
          </h2>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <button
                        onClick={() =>
                          navigate(ROUTES.destinations.detail(dest.id))
                        }
