...
export default function AdminDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      // Recent activity endpoint is not yet part of the guaranteed service contract.
      // Keep empty until a real backend endpoint + typed service method is added.
      setRecentActivity([]);
    } catch (err: any) {
    ...
    return (
      <div
        className={`bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-gray-100 ${
          link ? "cursor-pointer group hover:border-uganda-yellow" : ""
        }`}
      >
        {link ? (
          <Link
            to={link}
            className="block transform group-hover:scale-[1.02] transition-transform duration-200"
          >
            {content}
          </Link>
        ) : (
      ...
      <DashboardLayout role="admin">
        <div className="flex items-center justify-center min-h-96">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-uganda-yellow mx-auto" />
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard
            ...
            link={ROUTES.admin.destinations}
          />
          <StatCard
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                to={ROUTES.admin.activity}
                className="text-sm text-uganda-yellow hover:text-yellow-400 font-medium"
              >
                View all
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="text-blue-600 text-xl mb-2 group-hover:scale-110 transition-transform">
                  👥
                </div>
              ...
              >
                <div className="text-yellow-600 text-xl mb-2 group-hover:scale-110 transition-transform">
                  ✅
                </div>
              ...
              >
                <div className="text-green-600 text-xl mb-2 group-hover:scale-110 transition-transform">
                  📈
                </div>
              ...
              >
                <div className="text-purple-600 text-xl mb-2 group-hover:scale-110 transition-transform">
                  ⚙️
                </div>
