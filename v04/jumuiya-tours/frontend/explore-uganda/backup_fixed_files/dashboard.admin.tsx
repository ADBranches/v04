...
// import { dashboardService } from "../services/dashboard.service"; // ⬅️ use when you hook real API
...
export default function AdminDashboard() {
  ...
  const loadDashboardData = async () => {
    setLoading(true);
    try {
      // TODO: replace with real dashboardService calls
  ...
  // Loading state wrapped in dashboard layout
  if (loading) {
    return (
      <DashboardLayout>
