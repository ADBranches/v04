...
import RegisterForm from '../components/forms/register-form'; // ✅ Fixed import path
...
export default function Register() {
  ...
  const handleSuccess = (response: LoginResponse) => {
    // Success callback - navigation is already handled in RegisterForm
    ...
    <div className="bg-safari-sand min-h-screen flex items-center justify-center py-8">
      <div className="max-w-md w-full space-y-8 px-4">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-uganda-black">Join the adventure</h2>
          <p className="mt-2 text-gray-600">Create your account</p>
        </div>

        {/* Use the shared RegisterForm component */}
