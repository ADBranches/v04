...
// Get all users (Admin only) - FIXED TABLE NAMES
...
// Create new user (Admin only) - FIXED TABLE NAME
router.post('/users', authenticateToken, requireRole(['admin']), async (req, res) => {
  try {
    ...
    const result = await query(
      `INSERT INTO "User" (email, password_hash, name, role, guide_status) 
       VALUES ($1, $2, $3, $4, $5) 
...
// Update user role/status (Admin only) - FIXED TABLE NAME
...
// Get platform statistics (Admin only) - FIXED TABLE NAMES
